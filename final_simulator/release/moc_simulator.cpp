...
QT_MOC_LITERAL(7, 84, 15)
    ...
    "Simulator\0statusMessage\0\0msg\0"
    "onNewConnection\0onClientDisconnected\0"
    "onClientReadyRead\0onBroadcastTick"
};
...
void Simulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Simulator::statusMessage)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Simulator::statusMessage(const QString & _t1)
{
